...
Ngoài backend, repository hiện có thêm frontend React độc lập trong `frontend/` để phát triển UI riêng với backend. Hướng dẫn chạy frontend được tách sang `frontend/README.md` để giảm xung đột với tài liệu gốc ở root.
